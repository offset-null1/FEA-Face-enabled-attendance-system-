...
class detector(camera):
    ...
    def load_model(self,proto_path=None, weights_path=None):
        ...
        if proto_path is None:
            proto_path = os.path.join(os.environ['HOME'],'opencv/samples/dnn/face_detector/deploy.prototxt')
        if weights_path is None:
            weights_path = os.path.join(os.environ['HOME'],'opencv/samples/dnn/face_detector/res10_300x300_ssd_iter_140000_fp16.caffemodel')
